...
public class RemovePublicationCommandTest {
    @Mock
    ...
    private RemovePublicationCommand removePublicationCommand;
    ...
    public void setUp() {
        ...
        removePublicationCommand = new RemovePublicationCommand(applicationContext, securityService);
    }

    @Test
    public void shouldReturnCorrectUrlWhenNoErrors() {
        String actual = removePublicationCommand.execute(request, response);
    ...
    public void shouldInvokeRemoveMethodInService() {
        removePublicationCommand.execute(request, response);

        verify(publicationService, atLeast(1)).removePublication(any());
    }
}